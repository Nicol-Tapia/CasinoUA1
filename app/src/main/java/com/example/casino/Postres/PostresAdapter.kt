package com.example.casino.Bebidas
...
import com.example.casino.Postres.MenuItemPostres
import com.example.casino.R

class PostresAdapter(private val context: Context, private val menuItems: List<MenuItemPostres>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val menuItem = getItem(position) as MenuItemBebidas
